    ...
    <>
      <div className="landing">
        ...
        <h2 className="pageTitle">
          Donate to selected items below or donate directly Let&apos;s get{" "}
          <span>microbusinesses</span> the items they need!
        </h2>
        <div className="orgListCon">
          <Sidebar orgList={orgList} />
          <h2 className="orgList">Donate directly</h2>
        </div>
